      ...
      <div className="flex-none w-64">
        ...
        <div className="mt-1 relative shadow-sm">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center">
            <button className="btn inline-block px-6 py-2.5 bg-blue-500 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-blue-600 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-indigo-200 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
